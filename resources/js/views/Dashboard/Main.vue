    ...
    <div class="w-full box-border grid grid-cols-4 gap-4">
        <div class="w-full col-span-1">
            <div class="w-full bg-slate-300/10 box-border p-6 rounded-lg flex items-center mb-5">
                ...
                <div class="flex-1">
                    <div class="font-semibold text-slate-300 text-sm">Data Suplier</div>
                    <div class="font-semibold text-slate-300">
                        <span class="text-2xl font-bold">2</span>
                        <span class="text-xs"> Suplier</span>
                    </div>
                </div>
            </div>
            ...
            <div class="w-full bg-slate-300/10 box-border p-6 rounded-lg flex items-center mb-5">
                ...
                <div class="flex-1">
                    <div class="font-semibold text-slate-300 text-sm">Total Penerimaan</div>
                    <div class="font-semibold text-slate-300">
                        <span class="text-2xl font-bold">20</span>
                        <span class="text-xs"> Barang</span>
                    </div>
            ...
            <div class="w-full bg-slate-300/10 box-border p-6 rounded-lg flex items-center mb-5">
                ...
                <div class="flex-1">
                    <div class="font-semibold text-slate-300 text-sm">Total Pengeluaran</div>
                    <div class="font-semibold text-slate-300">
                        <span class="text-2xl font-bold">20</span>
                        <span class="text-xs"> Barang</span>
                    </div>
