            ...
            <table class="w-full box-border table-auto border-collapse">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="px-4 py-2 border-b border-t border-slate-600 text-left">B01</td>
                        <td class="px-4 py-2 border-b border-t border-slate-600 text-left">Acer-200</td>
                        <td class="px-4 py-2 border-b border-t border-slate-600 text-left">Rp 500.000</td>
